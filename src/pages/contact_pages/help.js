export const faqList = [
  {
    ...
    answer: `We use a variety of sustainable materials, including organic cotton, recycled polyester, bamboo, and Tencel. Our goal is to provide high-quality clothing that is both stylish and environmentally friendly.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Yes, we offer international shipping to many countries. Shipping rates and delivery times vary based on your location. Please check our Shipping Policy page for more details.`,
  },
  {
    question: `What is your return policy?`,
    answer: `We want you to be completely satisfied with your purchase. If you are not happy with your order, you can return it within 30 days of receipt for a full refund or exchange, provided the items are in their original condition with tags attached. Please visit our Returns & Exchanges page for more information.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Sign up for our newsletter to receive updates on new arrivals, exclusive promotions, and sustainable fashion tips. You can also follow us on social media to stay connected and be the first to know about our latest collections and initiatives.`,
  },
]
